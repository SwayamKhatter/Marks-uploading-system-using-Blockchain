...
const AddMenteeMarks = () => {
    const [addMenteeMarks,setAddMenteeMarks] = useState({
        mentee:"",
        marks:0
    })
    ...
    const handleChange = (fieldname, e)=>{
        setAddMenteeMarks({
            ...addMenteeMarks, [fieldname]:e.target.value
        })
    }

    const handleSubmit = (e)=>{
        e.preventDefault();
        console.log(addMenteeMarks)
    }
    return (
        <>
            <div
            ...
            >
                <h2 className="text-2xl font-bold text-white mb-6">Add Marks for Mentee</h2>
