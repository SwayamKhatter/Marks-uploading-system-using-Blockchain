...
const StudentCertificate = () => {
    ...
    const handleChange = (fieldname, e)=>{
        setStudentCertificate({
            ...studentCertificate, [fieldname]:e.target.value
        })
    }
    ...
    return (
        <>
            ...
            >
                <h2 className="text-2xl font-bold text-white mb-6">Student Certificate</h2>
                ...
                <form method="post" action="#">
                    ...
                    <div className="mb-4">
                        ...
                        >Certificate Token</label>
                        <input
                            className="mt-1 p-2 w-full bg-gray-700 border border-gray-600 rounded-md text-white"
                            type="number" onChange={(e)=>{handleChange('metadata',e)}}
                        />
                    </div>
