...
const VerifyCertificate = () => {
    const [verifyCertificate,setVerifyCertificate] = useState({
        certificate:0,
        student:"",
        metadata:""
    })
    ...
    const handleChange = (fieldname, e)=>{
        setVerifyCertificate({
            ...verifyCertificate, [fieldname]:e.target.value
        })
    }
        ...
        <>
            ...
            >
                ...
                <form method="post" action="#">
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-gray-300" htmlFor="certificate"
                        >Certificate ID</label>
                        <input
                            className="mt-1 p-2 w-full bg-gray-700 border border-gray-600 rounded-md text-white"
                            type="number" onChange={(e)=>{handleChange('certificate',e)}}
                        />
                    </div>
                    <div className="mb-4">
