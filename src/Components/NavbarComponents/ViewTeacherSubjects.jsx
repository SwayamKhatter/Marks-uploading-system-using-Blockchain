...
const handleChange = (fieldname, e)=>{
    setViewTeacher({
        ...viewTeacher, [fieldname]:e.target.value
    })
}
...
return (
    <>
        ...
        >
            <h2 className="text-2xl font-bold text-white mb-6">View Teacher Subjects</h2>

            <form method="post" action="#">
                <div className="mb-4">
                    <label className="block text-sm font-medium text-gray-300" htmlFor="teacher"
                    >Teacher Name</label>
                    <input
                        className="mt-1 p-2 w-full bg-gray-700 border border-gray-600 rounded-md text-white"
                        type="text" onChange={(e)=>{handleChange('teacher',e)}}
                    />
                </div>
