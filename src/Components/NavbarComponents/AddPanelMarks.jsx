...
const AddPanelMarks = () => {
    const [addPanelMarks,setAddPanelMarks] = useState({
        student:"",
        marks:0
    })
    ...
    const handleChange = (fieldname, e)=>{
        setAddPanelMarks({
            ...addPanelMarks, [fieldname]:e.target.value
        })
    }

    const handleSubmit = (e)=>{
        e.preventDefault();
        console.log(addPanelMarks)
    }
    return (
        <>
            <div
            ...
            >
                <h2 className="text-2xl font-bold text-white mb-6">Add Panel Marks</h2>
